            ...
            <div class="tab-pane fade show active" id="about" role="tabpanel" aria-labelledby="about-tab">
                ...
                <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
                    ...
                    <div class="mb-3 mt-5">
                        ...
                        <?php } ?>
                        <?php foreach ($books as $book) { $key = $book["key"]; ?>
                            <div class="row p-2">
                                <div class="col">
                                                    ...
                                                    <div class="row ">
                                                        ...
                                                        <div class="col align-self-center">
                                                            ...
                                                            <form>
                                                                ...
                                                                <div class="row m-2">
                                                                    <div class="col">
                                                                        <button type="button" class="btn btn-circle btn-dark d-block mx-auto" onclick="ajaxstock(<?php echo $key ?>, -$('#<?php echo $key ?>')[0].value)"> <span class="fa fa-minus"></span> </button>
                                                                    </div>
                                                                    <div class="col">
                                                                        <button type="button" class="btn btn-circle btn-dark d-block mx-auto" onclick="ajaxstock(<?php echo $key ?>, $('#<?php echo $key ?>')[0].value)"> <span class="fa fa-plus"></span></button>
                                                                    </div>
                                                                </div>
                                                            </form>
                                                        </div>
